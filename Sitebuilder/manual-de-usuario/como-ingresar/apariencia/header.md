...
<mark style="color:$info;">Administra los componentes visibles en el encabezado de la plataforma. Desde esta sección es posible habilitar o deshabilitar funcionalidades específicas, como el reloj, el selector de idioma, las redes sociales, el acceso para descargar la aplicación móvil y el cambio entre modo claro y oscuro. Además, permite definir el estilo de visualización del saldo para los usuarios.</mark>

***

### 1. Acceso al Módulo

**Ruta de Acceso:**  Site Builder > Partner > Apariencia > Header
...
* La configuración del estilo del saldo modifica únicamente la apariencia del componente, sin afectar el valor mostrado.
* Los cambios realizados en el módulo se aplican únicamente después de guardar la configuración.
* Los componentes habilitados serán visibles para los usuarios finales de acuerdo con la configuración establecida.

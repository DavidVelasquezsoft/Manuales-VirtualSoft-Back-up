---
description: >-
  Configura los diferentes Pop Ups que se mostrarán en la plataforma de usuarios
  online, con base en acciones específicas que realicen los jugadores.
---
...
<table><thead><tr><th width="174">Botón</th><th>Descripción</th></tr></thead><tbody><tr><td><img src="../../../.gitbook/assets/Vector (7).png" alt="" data-size="original"> / <img src="../../../.gitbook/assets/image (2).png" alt="" data-size="line"></td><td>Activa o inactiva el pop-up en la plataforma Usuarios Online.</td></tr><tr><td><img src="../../../.gitbook/assets/Icono papelera.png" alt="" data-size="original"></td><td>Elimina el pop-up.</td></tr></tbody></table>
...
<figure><img src="../../../.gitbook/assets/image (409).png" alt=""><figcaption><p>Figura#2: Captura de pantalla estilo de pop up mixto.</p></figcaption></figure>
...
<table><thead><tr><th width="207.3333740234375">Acción</th><th>Descripción</th></tr></thead><tbody><tr><td><img src="../../../.gitbook/assets/Vector (1) (1).png" alt=""> <strong><code>Primer inicio de sesión</code></strong></td><td>El Pop Up se mostrará cuando el usuario inicie sesión por primera vez en la plataforma.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (2) (1).png" alt=""> <strong><code>Próximo inicio de sesión</code></strong></td><td>El Pop Up se mostrará la próxima vez que el usuario inicie sesión después de que el Pop Up haya sido configurado.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (3).png" alt=""> <strong><code>Primer depósito</code></strong></td><td>El Pop Up se activará cuando el usuario realice su primer depósito en la plataforma.</td></tr><tr><td><img src="../../../.gitbook/assets/trophy.png" alt=""> <strong><code>Primera apuesta deportiva</code></strong></td><td>El Pop Up se mostrará cuando el usuario realice su primera apuesta en la sección de deportivas.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (4).png" alt=""> <strong><code>Primera apuesta de casino</code></strong></td><td>El Pop Up se mostrará cuando el usuario realice su primera apuesta en juegos de casino, ya sea slots o casino en vivo.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (5).png" alt=""> <strong><code>Retiro</code></strong></td><td>Activa el Pop Up en todas las solicitudes de retiro realizadas por el usuario.</td></tr><tr><td><img src="../../../.gitbook/assets/payments.png" alt=""> <strong><code>Próximo retiro</code></strong></td><td>Activa el Pop Up solo en la siguiente solicitud de retiro realizada por el usuario después de su configuración.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (6).png" alt=""> <strong><code>Próximo depósito</code></strong></td><td>El Pop Up se activará cuando el usuario realice el siguiente depósito posterior a la creación del Pop Up.</td></tr></tbody></table>

#### Configuración del pop up

<table data-full-width="false"><thead><tr><th>Campos</th><th width="462.0001220703125">Descripción</th></tr></thead><tbody><tr><td><strong><code>Agregar imagen</code></strong></td><td><p>Carga la imagen que se mostrará en el pop-up.</p><div data-gb-custom-block data-tag="hint" data-style="warning" class="hint hint-warning"><p><strong>Nota:</strong> Solo se permiten <strong>formatos</strong> (<em>JPG/PNG</em>), un <strong>peso</strong> máximo de 200 KB y un <strong>tamaño</strong> sugerido de 1027×486 px.</p></div></td></tr><tr><td><strong><code>Título</code></strong></td><td>Permite escribir el encabezado principal del Pop Up.</td></tr><tr><td><strong><code>Descripción</code></strong></td><td>Permite ingresar el mensaje del Pop Up, con un límite máximo de 300 caracteres.</td></tr></tbody></table>
...
<table><thead><tr><th width="121">Campo</th><th width="146">Tipo de control</th><th>Descripción</th></tr></thead><tbody><tr><td><strong><code>Texto del botón</code></strong></td><td>Texto</td><td>Texto visible en el botón del Pop Up.</td></tr><tr><td><strong><code>URL de redirección</code></strong></td><td>URL</td><td>Dirección a la que será redirigido el usuario al hacer clic en el botón.</td></tr><tr><td><strong><code>Agregar botón</code></strong></td><td>Botón</td><td>Agrega nuevos botones al Pop Up.</td></tr><tr><td><img src="../../../.gitbook/assets/image (408).png" alt="" data-size="original"></td><td>Botón</td><td>Elimina el botón configurado del Pop Up.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (8).png" alt="" data-size="original"></td><td>Arrastrar</td><td>Organiza el orden de los botones en el pop-up.</td></tr></tbody></table>
...
* Desde el botón  <img src="../../../.gitbook/assets/Vector (9).png" alt="" data-size="line"> se podrá visualizar un ejemplo de cómo quedaría el pop-up.
{% endhint %}
...
<figure><img src="../../../.gitbook/assets/image (410).png" alt=""><figcaption><p>Figura#3: Captura de pantalla estilo de pop up texto.</p></figcaption></figure>
...
* Los botones cuentan con configuraciones visuales predeterminadas según su posición. El botón 1 mantiene el estilo de acción primaria, el botón 2 el estilo de acción complementaria y el botón 3 el estilo de acción terciaria. Esta jerarquía visual se conserva incluso si se modifica el orden de los botones.
* Desde el botón  <img src="../../../.gitbook/assets/Vector (9).png" alt="" data-size="line"> se podrá visualizar un ejemplo de como quedaría el pop-up.
{% endhint %}
...
<figure><img src="../../../.gitbook/assets/image (411).png" alt=""><figcaption><p>Figura#4: Captura de pantalla estilo de pop up visual.</p></figcaption></figure>

#### Accionador

Permite configurar el evento que desencadenará la visualización del Pop Up. El sistema mostrará el mensaje automáticamente cuando el usuario cumpla la condición definida, según las acciones realizadas dentro de la plataforma.

<table><thead><tr><th width="186.50006103515625">Acción</th><th>Descripción</th></tr></thead><tbody><tr><td><img src="../../../.gitbook/assets/Vector (1) (1).png" alt=""> <strong><code>Primer inicio de sesión</code></strong></td><td>El Pop Up se mostrará cuando el usuario inicie sesión por primera vez en la plataforma.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (2) (1).png" alt=""> <strong><code>Próximo inicio de sesión</code></strong></td><td>El Pop Up se mostrará la próxima vez que el usuario inicie sesión después de que el Pop Up haya sido configurado.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (3).png" alt=""> <strong><code>Primer depósito</code></strong></td><td>El Pop Up se activará cuando el usuario realice su primer depósito en la plataforma.</td></tr><tr><td><img src="../../../.gitbook/assets/trophy.png" alt=""> <strong><code>Primera apuesta deportiva</code></strong></td><td>El Pop Up se mostrará cuando el usuario realice su primera apuesta en la sección de deportivas.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (4).png" alt=""> <strong><code>Primera apuesta de casino</code></strong></td><td>El Pop Up se mostrará cuando el usuario realice su primera apuesta en juegos de casino, ya sea slots o casino en vivo.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (5).png" alt=""> <strong><code>Retiro</code></strong></td><td>Activa el Pop Up en todas las solicitudes de retiro realizadas por el usuario.</td></tr><tr><td><img src="../../../.gitbook/assets/payments.png" alt=""> <strong><code>Próximo retiro</code></strong></td><td>Activa el Pop Up solo en la siguiente solicitud de retiro realizada por el usuario después de su configuración.</td></tr><tr><td><img src="../../../.gitbook/assets/Vector (6).png" alt=""> <strong><code>Próximo depósito</code></strong></td><td>El Pop Up se activará cuando el usuario realice el siguiente depósito posterior a la creación del Pop Up.</td></tr></tbody></table>

#### Configuración del pop up

<table data-full-width="false"><thead><tr><th>Campos</th><th width="462.0001220703125">Descripción</th></tr></thead><tbody><tr><td><strong><code>Agregar imagen</code></strong></td><td><p>Permite cargar la imagen que se mostrará en el pop-up.</p><div data-gb-custom-block data-tag="hint" data-style="warning" class="hint hint-warning"><p><strong>Nota:</strong> Solo se permiten <strong>formatos</strong> (<em>JPG/PNG</em>), un <strong>peso</strong> máximo de 200 KB y un <strong>tamaño</strong> sugerido de 1027×486 px.</p></div></td></tr></tbody></table>

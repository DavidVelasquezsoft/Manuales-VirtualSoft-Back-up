...
<figure><img src="../../../.gitbook/assets/image (716).png" alt=""><figcaption><p>Figura #5: Captura de pantalla sección solicitud de depósito de clientes.</p></figcaption></figure>
...
Permite configurar todas las opciones relacionadas con el programa de referidos y su aplicación en la plataforma [Usuarios Online](https://virtualsoft.gitbook.io/manuales/usuarios).
...
<table><thead><tr><th width="134">Campo</th><th width="106">Tipo de control</th><th>Descripción</th></tr></thead><tbody><tr><td><strong><code>Nombre de la Recompensa</code></strong></td><td>Texto</td><td>Nombre de la recompensa otorgada al usuario.</td></tr><tr><td><strong><code>Mínimo de Apuestas</code></strong></td><td>Campo numérico</td><td>Define el número mínimo de apuestas requeridas.</td></tr><tr><td><strong><code>Cuenta Verificada</code></strong></td><td>Selector</td><td>Indica si la cuenta debe estar verificada para recibir la recompensa.</td></tr><tr><td><strong><code>Eliminar Recompensa</code></strong></td><td>Botón</td><td>Elimina la recompensa configurada.</td></tr><tr><td><strong><code>categoría requerida.</code></strong></td><td>Botón</td><td><p></p><ul><li><strong>Bonos Disponibles</strong>: Muestra los bonos previamente creados que pueden agregarse.</li><li><strong>Bonos Seleccionados:</strong> Indica los bonos aplicados a la recompensa.</li></ul><p>Entre ambos recuadros se encuentran los siguientes botones:</p><ul><li><strong><code>>></code></strong> Mueve todas las categorías de la columna <strong>disponibles</strong> hacia <strong>seleccionados</strong>.</li><li><strong><code>&#x3C;&#x3C;</code></strong> Retorna todas las categorías desde <strong>disponibles</strong> hacia <strong>seleccionados</strong>.</li><li><strong><code>></code></strong> Mueve solo la categoría seleccionada desde <strong>disponibles</strong> hacia <strong>seleccionados</strong>.</li><li><strong><code>&#x3C;</code></strong> Retorna únicamente la categoría seleccionada desde <strong>seleccionados</strong> hacia <strong>disponibles</strong>.</li></ul></td></tr></tbody></table>
...
* Las configuraciones realizadas en este módulo no dependen de alguna plantilla _(Estructura configurada para el envío de correos electrónicos a los usuarios)_ previamente creada en la plataforma [Marketing](https://virtualsoft.gitbook.io/manuales/marketing).
...
* Los campos visualizados en este módulo dependen de los permisos asignados del usuario.
* Para aplicar los cambios realizados es necesario dar clic en el botón "Guardar" Ubicado en la parte inferior.

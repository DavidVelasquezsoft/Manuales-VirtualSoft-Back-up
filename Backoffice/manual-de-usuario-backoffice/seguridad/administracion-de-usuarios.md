...
<table><thead><tr><th width="185.888916015625">Campo</th><th width="127.5555419921875">Tipo de control</th><th>Descripción</th></tr></thead><tbody><tr><td><strong><code>Primer nombre</code></strong></td><td>Texto</td><td>Busca por primer nombre de usuario.</td></tr><tr><td><strong><code>Email</code></strong></td><td>Texto</td><td>Busca por correo electrónico.</td></tr><tr><td><strong><code>Ciudad</code></strong></td><td>Texto</td><td>Filtra resultados según la ciudad.</td></tr><tr><td><strong><code>Moneda</code></strong></td><td>Texto</td><td>Ingresa la moneda para filtrar los usuarios asociados a esta.</td></tr><tr><td><strong><code>Categoría cliente</code></strong></td><td>Lista desplegable</td><td>Permite buscar usuarios según su categoría.</td></tr></tbody></table>
...
Al ejecutar la consulta, en la parte inferior de la pantalla se despliega una tabla con los usuarios registrados en el Backoffice que cumplen con los filtros aplicados.

<table><thead><tr><th width="169.333251953125">Campo</th><th>Descripción</th></tr></thead><tbody><tr><td><code>🔎</code></td><td>Permite visualizar el detalle del usuario y acceder a sus configuraciones. Su contenido se detalla en <a href="administracion-de-usuarios.md#id-6.-detalles-del-usuario">Detalles del usuario</a>.</td></tr><tr><td><strong><code>ID Usuario</code></strong></td><td>Identificador único del usuario.</td></tr><tr><td><strong><code>Usuario</code></strong></td><td>Nombre de usuario utilizado para iniciar sesión en el BackOffice.</td></tr><tr><td><strong><code>Primer nombre</code></strong></td><td>Primer nombre del usuario.</td></tr><tr><td><strong><code>Teléfono</code></strong></td><td>Número de contacto registrado asociado al usuario.</td></tr><tr><td><strong><code>Fecha del último logueo</code></strong></td><td>Fecha y hora en la que el usuario inició sesión por última vez.</td></tr><tr><td><strong><code>Email</code></strong></td><td>Dirección de correo electrónico registrada.</td></tr><tr><td><strong><code>Estado</code></strong></td><td>Estado actual del usuario.</td></tr></tbody></table>
...
Una vez creado el usuario, es necesario habilitar su acceso a la plataforma mediante los siguientes pasos:
...
Por defecto, los usuarios nuevos se crean inactivos y sin acceso. Seleccionar la opción **Desbloquear usuario** para habilitar su ingreso.
{% endstep %}

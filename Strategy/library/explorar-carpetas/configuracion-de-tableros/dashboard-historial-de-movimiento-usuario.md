...
A continuación se describen los tipos de movimientos que puede registrar un usuario o un punto de venta, indicando su clasificación _(entrada, salida o cancelación)_ y el efecto que tienen sobre el saldo:

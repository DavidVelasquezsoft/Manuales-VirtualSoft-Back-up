...
<figure><img src="../../../.gitbook/assets/image (221).png" alt=""><figcaption><p>Figura #1: Captura ejemplo del dashboard.</p></figcaption></figure>

### 4. Filtros Disponibles

{% hint style="warning" %}
**Nota:** Los filtros varían según el tipo de vista seleccionada _(**Mensual**, **Diario** o **Puntos Calificables**)_. Los filtros de fecha definen el alcance temporal de todos los gráficos y tablas del tablero.
{% endhint %}
...
{% tabs %}
{% tab title="Mensual" %}
Permite visualizar información consolidada por mes del programa de lealtad. Incluye indicadores (KPI), gráficos estadísticos, rankings de usuarios y tablas de detalle relacionadas con la acumulación, redención y expiración de puntos.
...
<table><thead><tr><th width="179">Columna</th><th>Descripción</th></tr></thead><tbody><tr><td><strong><code>Fecha</code></strong></td><td>Indica la fecha en la que se redimió el premio lealtad</td></tr><tr><td><strong><code>Partner</code></strong></td><td>Partner en el que se redimieron los puntos.</td></tr><tr><td><strong><code>País</code></strong></td><td>País del usuario que realizó la redención.</td></tr><tr><td><strong><code>ID lealtad</code></strong></td><td>Identificador único del regalo redimido.</td></tr><tr><td><strong><code>Descripción Lealtad</code></strong></td><td>Descripción del regalo redimido por el usuario.</td></tr><tr><td><strong><code>ID Bono</code></strong></td><td>Identificador del bono asociado a la redención.</td></tr><tr><td><strong><code>Puntos requeridos</code></strong></td><td>Cantidad de puntos necesarios para redimir el regalo.</td></tr><tr><td><strong><code>Usuarios redimieron regalos</code></strong></td><td>Número de <a href="https://virtualsoft.gitbook.io/plantillas/glosario#usuarios-unicos">usuarios únicos</a> que realizaron la redención de este regalo.</td></tr><tr><td><strong><code>Cantidad compras</code></strong></td><td>Cantidad de veces que se redimió el premio lealtad.</td></tr></tbody></table>
{% endtab %}

{% tab title="Diario" %}
Visualiza el comportamiento del programa de lealtad consolidado por día. Incluye indicadores (KPI), gráficos estadísticos, rankings de usuarios y tablas de detalle relacionadas con la acumulación, redención y expiración de puntos.

---
description: >-
  Aquí encontrarás todo lo relacionado con los reportes, desde su creación hasta
...
{% hint style="warning" %}
**Nota**: Si se utilizan los atributos "**Ticket Ganador**" o "**Tipo Vertical Ganador**" para generar otro reporte, esto hará que todo el reporte se filtre solo por información del ganador.
{% endhint %}
...
* **Información por vertical deportivas y casino en Jackpot**: Puedes generar reportes con información sobre de las verticales Casino y Deportivas.
  * **Ruta para indicadores**:
    * Todos los objetos/ Indicadores/ Jackpot.
  * **Ruta para Atributos:**
    * Todos los objetos/ Jackpot/ Avances Jackpot.

{% hint style="warning" %}
**Nota**: Para diferenciar entre la información de la vertical deportivas y casino se puede tener en cuenta lo siguiente:

* **Deportivas**: El Id del ticket (Apuesta) será solo de números.
* **Casino**: El Id del ticket (Apuesta) será de números y letras.
{% endhint %}

## Editar reporte generado:

...
{% hint style="warning" %}
Nota: Los campos de configuración para el Rollover son dimámicos, desplegarán según el campo configurado.
{% endhint %}

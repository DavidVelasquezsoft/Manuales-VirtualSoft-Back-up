...
EGT es un proveedor de juegos casino slot y en vivo, en este manual encontrarás información sobre su integración realizada a la plataforma de apuestas.
...
Busca los juegos del proveedor EGT haciendo clic en el ícono "+" ubicado en la esquina derecha. Esto te permitirá explorar.

<figure><img src="../../.gitbook/assets/image (60).png" alt=""><figcaption><p>Figura #1: Captura de pantalla filtro proveedores.</p></figcaption></figure>
...
* **Menú/ Reportes/ Reporte de Casino**.
...
<figure><img src="../../.gitbook/assets/image (48).png" alt=""><figcaption><p>Figura #2: Captura de pantalla filtros de búsqueda.</p></figcaption></figure>

En este caso se explicarán solo los filtros necesarios para visualizar el reporte de EGT.

* **Proveedor**: En este filtro debes seleccionar el proveedor EGT, esto para visualizar solo los reportes de dicho proveedor.
...
<figure><img src="../../.gitbook/assets/image (28).png" alt=""><figcaption><p>Figura #3: Captura de pantalla de ejemplo.</p></figcaption></figure>

...
description: >-
  ...
  de la creación de un bono FreeSpin para el proveedor Betixon.
---
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor **Betixon**, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:
...
<summary>🔽 Valores permitidos por ronda</summary>

El campo **Valor por ronda** acepta únicamente los siguientes valores configurados:

<table><thead><tr><th width="305.5" align="center">Valor</th><th align="center">Apuesta</th></tr></thead><tbody><tr><td align="center">0</td><td align="center">1.00 PEN</td></tr><tr><td align="center">1</td><td align="center">2.00 PEN</td></tr><tr><td align="center">2</td><td align="center">5.00 PEN</td></tr><tr><td align="center">3</td><td align="center">10.00 PEN</td></tr><tr><td align="center">4</td><td align="center">25.00 PEN</td></tr><tr><td align="center">5</td><td align="center">50.00 PEN</td></tr></tbody></table>

{% hint style="warning" %}
**Nota:** Solo se permiten los valores indicados en la tabla. Si se ingresa un valor distinto, el sistema no permitirá continuar con la configuración.
{% endhint %}
...
| ------- | ---------- | --------------- | ------------------ |
| 1.0     | 04/03/2026 | David velasquez | Documento inicial  |

...
description: >-
  ...
  de la creación de un bono FreeSpin para TBP Games.
---
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor TBP Games, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:
...
| ------- | ---------- | --------------- | ------------------ |
| 1.0     | 27/01/2026 | David Velasquez | Documento inicial  |

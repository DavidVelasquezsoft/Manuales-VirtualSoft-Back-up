...
description: >-
  ...
  de la creación de un bono FreeSpin para el proveedor Just Slots.
---
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor Just Slots, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:
...
<a href="https://virtualsoft.gitbook.io/manuales/integraciones./manual-integraciones-por-proveedor./proveedores-con-configuraciones-para-bonos./just-slots#id-3.-acciones-del-usuario" class="button secondary">Regresar</a>
...
* El bono solo se puede crear para un único juego, en caso de crearlo para distintos juegos, se creará, pero no se le asignará a ningún usuario.

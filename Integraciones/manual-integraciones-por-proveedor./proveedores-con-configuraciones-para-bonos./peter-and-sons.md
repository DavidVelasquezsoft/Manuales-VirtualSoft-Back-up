...
description: >-
  ...
  de la creación de un bono FreeSpin para el proveedor Peter & Sons.
---
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor Peter & Sons, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:
...
* Un mismo bono puede configurarse y aplicarse a múltiples juegos dentro de una sola creación.

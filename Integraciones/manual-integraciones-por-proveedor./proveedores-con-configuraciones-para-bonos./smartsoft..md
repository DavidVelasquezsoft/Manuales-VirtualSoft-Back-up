...
description: >-
  ...
  de la creación de un bono FreeSpin para SMARTSOFT.
---
...
En este caso nos céntratenos solo en las configuraciones necesarias para la configuración de los nuevos juegos integrados por el proveedor SMARTSOFT.
...
{% hint style="warning" %}
**Nota**: En el caso de este proveedor, le fecha final no puede ser superior a 6 meses.
{% endhint %}

* **Botón proveedores:** Este botón Desplegará un listado solo con los proveedores que tienen el Bonus System activo, en este caso se debe visualizar y seleccionar la opción "**SMARTSOFT"**.
* **Botón Productos:** Este botón despegará 2 listas para seleccionar un juego dependiendo el proveedor, en este caso, es necesario volver a seleccionar el proveedor "**SMARTSOFT**", para visualizar los juegos disponibles.
...
*   **Moneda**: Para poder dar uso a los bonos FreeSpin con el proveedor SMARTSOFT, es necesario seleccionar la moneda del país con el que estamos generando el bono, esto activará las siguientes configuraciones.
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor SMARTSOFT, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:

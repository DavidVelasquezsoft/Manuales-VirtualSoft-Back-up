...
En este caso nos céntratenos solo en las configuraciones necesarias para los nuevos juegos integrados por el proveedor EGT.
...
* **Botón proveedores:**  Este botón Desplegará un listado solo con los proveedores que tienen el Bonus System activo, en este caso se debe visualizar y seleccionar la opción "**EGT**".
* **Botón Productos:** Este botón despegará 2 listas para seleccionar un juego dependiendo el proveedor, en este caso, es necesario volver a seleccionar el proveedor "**EGT**", para visualizar los juegos disponibles.
...
* **Moneda**: Para poder dar uso a los bonos FreeSpin con el proveedor EGT, es necesario seleccionar la moneda del país con el que estamos generando el bono, esto activará las siguientes configuraciones.
  *   **Valor por ronda:** Este es el monto que tendrá el bono por cada ronda jugada. Al configurar esta opción, es crucial verificar previamente el monto de apuesta permitido en los juegos seleccionados, ya que este debe coincidir exactamente con el valor ingresado en este campo.
      ...
      <div data-gb-custom-block data-tag="hint" data-style="warning" class="hint hint-warning"><p><strong>Nota</strong>: Si no se da un valor por ronda, se define por defecto la cuota mínima del juego.</p></div>
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor EGT, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:
...
Al seguir esta ruta podrás filtrar solo los juegos disponibles por el proveedor EGT.

<figure><img src="../../.gitbook/assets/image (60).png" alt=""><figcaption><p>Figura #2: Captura de pantalla filtro proveedores.</p></figcaption></figure>

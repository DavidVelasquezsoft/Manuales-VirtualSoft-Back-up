...
description: >-
  ...
  de la creación de un bono FreeSpin para el proveedor AMIGOGAMING.
---
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor AMIGOGAMING, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:
...
| ------- | ---------- | ------------- | ------------------ |
| 1.0     | 16/12/2025 | Ronald Pelaez | Documento inicial  |

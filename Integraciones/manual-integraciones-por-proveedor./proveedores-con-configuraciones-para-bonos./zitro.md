...
description: >-
  ...
  de la creación de un bono FreeSpin para "zitro"
---
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor Zitro, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:
...
* La cantidad de giros asignados no puede ser menor a 1.
...
| ------- | ---------- | ----------- | ----------------------- |
| 1.0     | 09/09/2025 | Karol Navia | Documento inicial Zitro |

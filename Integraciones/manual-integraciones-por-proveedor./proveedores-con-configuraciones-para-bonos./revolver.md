...
description: >-
  ...
  de la creación de un bono FreeSpin para el proveedor Revolver.
---
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor Revolver, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:
...
<a href="revolver.md#id-3.-acciones-del-usuario" class="button secondary">Regresar</a>
...
| ------- | ---------- | --------------- | ------------------ |
| 1.0     | 06/02/2026 | David velasquez | Documento inicial  |

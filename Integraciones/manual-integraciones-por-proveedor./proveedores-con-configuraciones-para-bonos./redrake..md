...
description: >-
  ...
  de la creación de un bono FreeSpin para REDRAKE.
---
...
En este caso nos céntratenos solo en las configuraciones necesarias para la configuración de los nuevos juegos integrados por el proveedor REDRAKE.
...
* **Botón proveedores:** Este botón Desplegará un listado solo con los proveedores que tienen el Bonus System activo, en este caso se debe visualizar y seleccionar la opción "**REDRAKE"**.
* **Botón Productos:** Este botón despegará 2 listas para seleccionar un juego dependiendo el proveedor, en este caso, es necesario volver a seleccionar el proveedor "**REDRAKE**", para visualizar los juegos disponibles.
...
* **Moneda**: Para poder dar uso a los bonos FreeSpin con el proveedor **REDRAKE**, es necesario seleccionar la moneda del país con el que estamos generando el bono, esto activará las siguientes configuraciones.
  *   **Valor por ronda:** Este es el monto que tendrá el bono por cada ronda jugada. Al configurar esta opción, es crucial verificar previamente el monto de apuesta permitido en los juegos seleccionados, ya que este debe coincidir exactamente con el valor ingresado en este campo.<br>
  ...
  * **Rondas gratuitas**: En este campo debes especificar el total de rondas gratuitas que se le otorgarán al usuario.
  ...
  * Días de rondas gratis: Indica la cantidad de días de vigencia del freeSpin

{% hint style="warning" %}
**Nota**: Para este proveedor el valor por ronda es en euros.
{% endhint %}

Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor REDRAKE, en caso de necesitar información más detallada sobre cómo crear el bono FreeSpin, puedes acceder a la siguiente página:

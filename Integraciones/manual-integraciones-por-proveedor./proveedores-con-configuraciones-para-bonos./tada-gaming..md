...
description: >-
  ...
  de la creación de un bono FreeSpin para TaDa gaming.
---
...
En este caso nos céntratenos solo en las configuraciones necesarias para los nuevos juegos integrados por el proveedor TaDa Gaming.

* **Botón proveedores:** El botón "**Proveedores**", desplegará solo los proveedores que tienen el Bonus System activo, en este caso se debe visualizar y seleccionar la opción "**TADAGAMING**".
* **Botón Productos:** El botón "**Productos**", despegará 2 listas para seleccionar un juego dependiendo el proveedor, en este caso, es necesario volver a seleccionar el proveedor "**TADAGAMING**", para visualizar los juegos disponibles.
...
*   **Moneda**: ara poder dar uso a los bonos FreeSpin con el proveedor TaDa gaming, es necesario seleccionar la moneda del país con el que estamos generando el bono, esto activará las siguientes configuraciones.
...
Estas son las configuraciones principales y necesarias para generar un bono FreeSpin con los juegos del proveedor TaDa Gaming.
...
{% hint style="warning" %}
**Nota**: Los bonos se crean inmediatamente, pero se asignan en aproximadamente 2 a 3 minutos.
{% endhint %}

## TaDa gaming en plataforma:

Realizaremos el ejemplo desde la plataforma Doradobet desde la siguiente ruta:&#x20;

* **Menú/ Casino/ TaDa gaming.**

Al seguir esta ruta podrás filtrar solo los juegos disponibles por el proveedor TaDa gaming.

<figure><img src="../../.gitbook/assets/image (58).png" alt=""><figcaption><p>Figura #2: Captura de pantalla Juegos filtrados.</p></figcaption></figure>
